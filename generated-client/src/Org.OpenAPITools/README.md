...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IPropertiesApi>();
            CreatePropertyApiResponse apiResponse = await api.CreatePropertyAsync("todo");
            Property model = apiResponse.Ok();
        }
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {7878F61F-C166-4D9F-A9CC-3E102CF0FA78}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
